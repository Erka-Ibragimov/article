  ...
  describe('getAll', () => {
    it('should return articles based on the query', async () => {
      ...
      const query: AllArticleQuery = {
        author: 'Erka',
        startDate: new Date('2024-06-08T02:11:55.777Z'),
        endDate: new Date('2024-10-08T02:11:55.777Z'),
        page: 1,
        take: 10,
      };
      ...
      jest.spyOn(articleRepository, 'find').mockResolvedValue([
        {
          ...
          created_at: new Date('2024-06-10T02:11:55.777Z'),
          updated_at: new Date('2024-06-10T02:11:55.777Z'),
        },
        {
          id: 2,
          name: 'Test Article 2',
      ...
      expect(articleRepository.find).toHaveBeenCalledWith({
        where: {
          ...
          auth: { id: auth.id },
          created_at: Between(
            new Date('2024-06-08T02:11:55.777Z'),
            new Date('2024-10-08T02:11:55.777Z'),
          ),
        },
